function search(event) {
    ...
    if (event.key === 'Enter') {
        ...
        // Check the search term and redirect accordingly
        if (searchTerm === 'men') {
            window.location.href = '#men';
        } else if (searchTerm === 'women') {
            window.location.href = '#women';
        } else if (searchTerm === 'trends') {
            window.location.href = '#trends';
        } else if (searchTerm === 'blogs') {
            window.location.href = '#blogs';
        } else {
            // You can add more conditions or handle other cases
            console.log('Search term not recognized. Search term:', searchTerm);
        }
    }
}
